                  ...
                  IN PVOID xhciEndpoint)
{
	...
	//XHCI_LOG("XHCI_OpenEndpoint called\n");
                    ...
                    IN PVOID xhciEndpoint)
{
	...
	//XHCI_LOG("XHCI_ReopenEndpoint called\n");
    return MP_STATUS_SUCCESS;
}
...
{
	//XHCI_LOG("XHCI_CloseEndpoint called\n");	
...
XHCI_ProcessEvent (IN PXHCI_EXTENSION XhciExtension)
{
	...
	//XHCI_LOG("XHCI_ProcessEvent called\n");		
                  ...
                  IN PXHCI_EXTENSION XhciExtension)
{
	...
	//XHCI_LOG("XHCI_SendCommand called\n");	
                        ...
                        IN PVOID resourcesStartPA)
{
	...
	//XHCI_LOG("XHCI_ControllerWorkTest called\n");		
                         ...
                         IN PVOID resourcesStartPA)
{
	...
	//XHCI_LOG("XHCI_InitializeResources called\n");	
    DPRINT_XHCI("XHCI_InitializeResources: BaseVA - %p, BasePA - %p\n",
                resourcesStartVA,
                resourcesStartPA);
				
	//XHCI_LOG("XHCI_InitializeResources: function initiated\n");			
                     ...
                     IN PUSBPORT_RESOURCES Resources)
{
	...
	//XHCI_LOG("XHCI_StartController: function initiated\n");
...
XHCI_SubmitTransfer(IN PVOID xhciExtension,
                    ...
                    IN PVOID sgList)
{
	//XHCI_LOG("XHCI_SubmitTransfer called\n");		
...
{
	//XHCI_LOG("XHCI_SubmitIsoTransfer called\n");		
...
{
	//XHCI_LOG("XHCI_AbortIsoTransfer called\n");		
...
XHCI_AbortAsyncTransfer(IN PXHCI_EXTENSION xhciExtension,
                        ...
                        IN PXHCI_TRANSFER xhciTransfer)
{
	//XHCI_LOG("XHCI_AbortAsyncTransfer called\n");	
...
{
	//XHCI_LOG("XHCI_AbortTransfer called\n");	
...
XHCI_GetEndpointState(IN PVOID xhciExtension,
                      IN PVOID xhciEndpoint)
{
	//XHCI_LOG("XHCI_GetEndpointState called\n");		
...
{
	//XHCI_LOG("XHCI_SetEndpointState called\n");		
...
XHCI_PollEndpoint(IN PVOID xhciExtension,
                  IN PVOID xhciEndpoint)
{
	//XHCI_LOG("XHCI_PollEndpoint called\n");			
...
{
	//XHCI_LOG("XHCI_CheckController called\n");		
...
{
	//XHCI_LOG("XHCI_Get32BitFrameNumber called\n");	
...
{
	//XHCI_LOG("XHCI_InterruptNextSOF called\n");		
...
XHCI_SetEndpointDataToggle(IN PVOID xhciExtension,
                           ...
                           IN ULONG DataToggle)
{
	//XHCI_LOG("XHCI_SetEndpointDataToggle called\n");		
...
XHCI_GetEndpointStatus(IN PVOID xhciExtension,
                       IN PVOID xhciEndpoint)
{
	//XHCI_LOG("XHCI_GetEndpointStatus called\n");	
...
{
	//XHCI_LOG("XHCI_SetEndpointStatus called\n");	
...
{
	//XHCI_LOG("XHCI_StartSendOnePacket called\n");	
...
XHCI_EndSendOnePacket(IN PVOID xhciExtension,
                      ...
                      IN USBD_STATUS * pUSBDStatus)
{
	//XHCI_LOG("XHCI_EndSendOnePacket called\n");		
...
{
	//XHCI_LOG("XHCI_RebalanceEndpoint called\n");		
...
{
	//XHCI_LOG("XHCI_FlushInterrupts called\n");	
...
XHCI_RH_ChirpRootPort(IN PVOID xhciExtension,
                      IN USHORT Port)
{
	//XHCI_LOG("XHCI_RH_ChirpRootPort called\n");	
...
{
	PULONG OperationalRegs;
	//XHCI_LOG("XHCI_TakePortControl called\n");		

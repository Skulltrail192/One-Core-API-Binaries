...
@ stdcall -stub EtwReceiveNotificationsA() # DbgPrint prototype
@ stdcall -stub EtwReceiveNotificationsW() # DbgPrint prototype
...
@ stdcall EtwpGetTraceBuffer(ptr ptr ptr ptr)
...
@ stdcall LdrFindResourceEx_U(long ptr ptr long ptr) ; 5.1 and higher
...
@ stdcall RtlMapSecurityErrorToNtStatus(long) #Uncommented
...
@ stdcall ZwSetSystemEnvironmentValueEx(ptr ptr ptr long long)

...
#undef USE_GL_FUNC
    ...
    {
        const char *extensions = (const char*)gl_info->gl_ops.gl.p_glGetString(GL_EXTENSIONS);
        if (!strstr(extensions, "GL_ARB_compatibility"))
            wined3d_settings.max_gl_version = MAKEDWORD_VERSION(3, 2);
    }

...
@ stdcall EnumResourceNamesExA(ptr str ptr long long long) kernel32.EnumResourceNamesExA
@ stdcall EnumResourceNamesExW(ptr wstr ptr long long long) kernel32.EnumResourceNamesExW
@ stdcall EnumResourceTypesExA(ptr ptr long long long) kernel32.EnumResourceTypesExA
@ stdcall EnumResourceTypesExW(ptr ptr long long long) kernel32.EnumResourceTypesExW

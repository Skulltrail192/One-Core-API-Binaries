...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->TestCooperativeLevel(ppDevice3D);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->GetAvailableTextureMem(ppDevice3D);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->EvictManagedResources(ppDevice3D);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->GetDeviceCaps(ppDevice3D, caps);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->GetDisplayMode(ppDevice3D, swapchain, mode);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->GetCreationParameters(ppDevice3D, parameters);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->SetCursorProperties(ppDevice3D, hotspot_x, hotspot_y, bitmap);
	}
...
{
	if(ppDevice3D!=NULL){
		(ppDevice3D)->lpVtbl->SetCursorPosition(ppDevice3D, x, y, flags);
	}
}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->ShowCursor(ppDevice3D, show);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->CreateAdditionalSwapChain(ppDevice3D, present_parameters, swapchain);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->GetBackBuffer(ppDevice3D, swapchain, backbuffer_idx, backbuffer_type, backbuffer);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->GetRasterStatus(ppDevice3D, swapchain, raster_status);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->SetDialogBoxMode(ppDevice3D, enable);
	}
...
{
	if(ppDevice3D!=NULL){
		(ppDevice3D)->lpVtbl->SetGammaRamp(ppDevice3D, swapchain, flags, ramp);
	}
}
...
{
	if(ppDevice3D!=NULL){
		(ppDevice3D)->lpVtbl->GetGammaRamp(ppDevice3D, swapchain, ramp);
	}
}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->CreateTexture(ppDevice3D, width, height, levels, usage, format, pool, texture, shared_handle);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->CreateVolumeTexture(ppDevice3D, width, height, depth, levels, usage, format, pool, texture, shared_handle);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->CreateCubeTexture(ppDevice3D, edge_length, levels, usage, format, pool, texture, shared_handle);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->CreateVertexBuffer(ppDevice3D, size, usage, fvf, pool, buffer, shared_handle);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->CreateRenderTarget(ppDevice3D, width, height, format, multisample_type, multisample_quality, lockable, surface, shared_handle);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->CreateDepthStencilSurface(ppDevice3D, width, height, format, multisample_type, multisample_quality, discard, surface, shared_handle);
	}
...
{
	if(ppDevice3D!=NULL){
		return (ppDevice3D)->lpVtbl->CreateOffscreenPlainSurface(ppDevice3D, width, height, format, pool, surface, shared_handle);
	}

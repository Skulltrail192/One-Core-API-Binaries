...
// {
    ...
    // if (!(bitmap = CreateDIBSection(dc, bmpInfo, DIB_RGB_COLORS,(void **)&pBits, NULL, 0)/*CreateDIBitmap(dc, bmpHeader, CBM_INIT, desc->pMemory, bmpInfo, DIB_RGB_COLORS)*/)) goto error;

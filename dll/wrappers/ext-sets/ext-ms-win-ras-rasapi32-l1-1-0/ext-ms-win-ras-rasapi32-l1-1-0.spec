@ stdcall RasAutoDialSharedConnection() rasapi32.RasAutoDialSharedConnection
...
@ stdcall RasGetCredentialsW(wstr wstr ptr) rasapi32.RasGetCredentialsW
@ stdcall RasGetEntryDialParamsW(wstr ptr ptr) rasapi32.RasGetEntryDialParamsW
@ stdcall RasGetEntryHrasconnW(wstr wstr ptr) rasapi32.RasGetEntryHrasconnW
...
@ stdcall RasQuerySharedAutoDial(ptr) rasapi32.RasQuerySharedAutoDial
@ stdcall RasQuerySharedConnection(ptr) rasapi32.RasQuerySharedConnection

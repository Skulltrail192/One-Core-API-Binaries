...
@ cdecl _crt_at_quick_exit(long) ucrtbase._crt_at_quick_exit
...
@ cdecl _invoke_watson() ucrtbase._invoke_watson
@ cdecl _query_app_type() ucrtbase._query_app_type
@ cdecl _register_onexit_function(ptr ptr) ucrtbase._register_onexit_function
@ cdecl _register_thread_local_exe_atexit_callback(long) ucrtbase._register_thread_local_exe_atexit_callback
...
@ cdecl feclearexcept() ucrtbase.feclearexcept
@ cdecl fegetenv(ptr) ucrtbase.fegetenv
@ cdecl fegetexceptflag() ucrtbase.fegetexceptflag
@ cdecl fegetround() ucrtbase.fegetround
@ cdecl feholdexcept() ucrtbase.feholdexcept
@ cdecl fesetenv() ucrtbase.fesetenv
@ cdecl fesetexceptflag() ucrtbase.fesetexceptflag
@ cdecl fesetround() ucrtbase.fesetround
@ cdecl fetestexcept() ucrtbase.fetestexcept
@ cdecl perror(str) ucrtbase.perror
@ cdecl quick_exit() ucrtbase.quick_exit

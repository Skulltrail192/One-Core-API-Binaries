...
@ stdcall SetFileCompletionNotificationModes(ptr str) kernelbasex.SetFileCompletionNotificationModes
...
;missing funcions for XP x64
@ stdcall BaseProcessStartThunk(ptr ptr) 
@ stdcall BaseThreadStartThunk(ptr) 
...
@ stdcall SetSearchPathMode(long) kernelbasex.SetSearchPathMode

...
DWORD WINAPI GetDynamicTimeZoneInformationRaw(PDYNAMIC_TIME_ZONE_INFORMATION systemTime, BOOL comparation)
{
  ...
  if ( TRUE)//IsTimeZoneRedirectionEnabled() )
  {
...
BOOL WINAPI SetDynamicTimeZoneInformation(PDYNAMIC_TIME_ZONE_INFORMATION lpTimeZoneInformation)
{
  ...
  if ( 1)//IsTimeZoneRedirectionEnabled() )
  {
...
void WINAPI GetSystemTimePreciseAsFileTime(LPFILETIME lpSystemTimeAsFileTime)
{
  ...
  //lpSystemTimeAsFileTime->dwLowDateTime = RtlGetSystemTimePrecise();
  //lpSystemTimeAsFileTime->dwHighDateTime = other;

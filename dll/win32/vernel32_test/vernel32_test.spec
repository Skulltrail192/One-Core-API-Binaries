...
@ stdcall GetSystemFirmwareTable(long long ptr long) kernelfull.GetSystemFirmwareTable ;Need implement for XP and 2003 RTM
...
@ stdcall SetFileCompletionNotificationModes(ptr long); 2K3 SP2 has it!

...
@ cdecl __wcslwr(wstr)
@ cdecl -version=0x600+ __wcslwr_l(wstr ptr)
@ cdecl -version=0x600+ __wcslwr_s(wstr long)
@ cdecl -version=0x600+ __wcslwr_s_l(wstr long ptr)
@ cdecl _wcsncoll(wstr wstr long)
@ cdecl -version=0x600+ _wcsncoll_l(wstr wstr long ptr)
@ cdecl __wcsnicmp(wstr wstr long)
@ cdecl -version=0x600+ __wcsnicmp_l(wstr wstr long ptr)

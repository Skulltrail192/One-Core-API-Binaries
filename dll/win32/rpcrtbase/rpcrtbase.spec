...
@ stub I_RpcBindingInqLocalClientPID 
...
#For XP x64
@ stub Ndr64AsyncClientCall
@ stub Ndr64AsyncServerCall64
@ stub Ndr64AsyncServerCallAll
@ stub Ndr64DcomAsyncClientCall
@ stub Ndr64DcomAsyncStubCall
@ stub NdrClientCall3
@ stub NdrMesProcEncodeDecode3
@ stub NdrMesSimpleTypeAlignSizeAll
@ stub NdrMesSimpleTypeDecodeAll
@ stub NdrMesSimpleTypeEncodeAll
@ stub NdrMesTypeAlignSize3
@ stub NdrMesTypeDecode3
@ stub NdrMesTypeEncode3
@ stub NdrMesTypeFree3
@ stub NdrServerCallAll
@ stub NdrServerCallNdr64
@ stub NdrStubCall3
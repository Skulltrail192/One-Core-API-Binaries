...
@ stdcall RtlDosPathNameToNtPathName_U_WithStatus(wstr ptr ptr ptr) ntdll.RtlDosPathNameToNtPathName_U_WithStatus ; 5.2 SP1, and higher
...
@ stdcall RtlGetCurrentProcessorNumber() ntdll.RtlGetCurrentProcessorNumber ; 5.2 SP1 and higher

...
;missing functions from Server 2003 - need realoc
...
@ stdcall EtwpGetTraceBuffer(long long long long)
@ stdcall EtwpSetHWConfigFunction(long long)
...
;@ stdcall EtwpSendWmiKMRequest(long long long long long long long wstr) ;needed for advapi32 from 51

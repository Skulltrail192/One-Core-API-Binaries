...
;@ stdcall -arch=i386 KiFastSystemCall() ;comment for now (2k3 rtm)
;@ stdcall -arch=i386 KiFastSystemCallRet() ;comment for now (2k3 rtm)
;@ stdcall -arch=i386 KiIntSystemCall() ;comment for now (2k3 rtm)

...
@ stub PaintMonitor ;not-implemented
...
@ stdcall SoundSentry()
@ stdcall StartDCE() ;implemented
@ stdcall StopDCE() ;implemented
@ stdcall SwitchDesktopWithFade(ptr long)
@ stdcall _UserTestTokenForInteractive(ptr ptr) ;from Winsrv

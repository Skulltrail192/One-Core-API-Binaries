...
@ stdcall -arch=x86_64 RtlLookupFunctionEntry(ptr ptr ptr) 
@ stdcall -arch=x86_64 RtlPcToFileHeader(ptr ptr) 
@ stdcall -arch=x86_64 RtlRaiseException(ptr) 
@ stdcall -arch=x86_64 RtlRestoreContext(ptr ptr) 
@ stdcall -arch=x86_64 RtlUnwindEx(ptr ptr ptr ptr ptr ptr)
@ stdcall -arch=x86_64 RtlVirtualUnwind(ptr ptr ptr long) 

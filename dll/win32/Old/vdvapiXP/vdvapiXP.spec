...
@ stdcall CreateProcessAsUserSecure(ptr str str ptr ptr long long ptr str ptr ptr)  ;don't need for now
...
@ stdcall QueryWindows31FilesMigration(long)  ;don't need for now

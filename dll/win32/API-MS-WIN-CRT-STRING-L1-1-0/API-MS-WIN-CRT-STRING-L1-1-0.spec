...
@ cdecl __iswcsym() ucrtbase.__iswcsym
@ cdecl __iswcsymf() ucrtbase.__iswcsymf
@ cdecl __strncnt() ucrtbase.__strncnt
@ cdecl __wcsncnt() ucrtbase.__wcsncnt
@ cdecl _isalnum_l(long ptr) ucrtbase._isalnum_l
@ cdecl _isalpha_l(long ptr) ucrtbase._isalpha_l
@ cdecl _isblank_l() ucrtbase._isblank_l
...
@ cdecl _ispunct_l() ucrtbase._ispunct_l
@ cdecl _isspace_l(long ptr) ucrtbase._isspace_l
@ cdecl _isupper_l(long ptr) ucrtbase._isupper_l
@ cdecl _iswalnum_l() ucrtbase._iswalnum_l
@ cdecl _iswalpha_l(long ptr) ucrtbase._iswalpha_l
@ cdecl _iswblank_l() ucrtbase._iswblank_l
@ cdecl _iswcntrl_l() ucrtbase._iswcntrl_l
@ cdecl _iswcsym_l() ucrtbase._iswcsym_l
@ cdecl _iswcsymf_l() ucrtbase._iswcsymf_l
@ cdecl _iswctype_l() ucrtbase._iswctype_l
@ cdecl _iswdigit_l(long ptr) ucrtbase._iswdigit_l
@ cdecl _iswgraph_l() ucrtbase._iswgraph_l
@ cdecl _iswlower_l() ucrtbase._iswlower_l
@ cdecl _iswprint_l() ucrtbase._iswprint_l
@ cdecl _iswpunct_l(long ptr) ucrtbase._iswpunct_l
@ cdecl _iswspace_l(long ptr) ucrtbase._iswspace_l
@ cdecl _iswupper_l() ucrtbase._iswupper_l
@ cdecl _iswxdigit_l() ucrtbase._iswxdigit_l
...
@ cdecl _memicmp_l() ucrtbase._memicmp_l
...
@ cdecl _strset_s() ucrtbase._strset_s
...
@ cdecl _wcsnset_s() ucrtbase._wcsnset_s
...
@ cdecl _wctype() ucrtbase._wctype
...
@ cdecl towctrans() ucrtbase.towctrans

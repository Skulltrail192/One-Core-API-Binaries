...
@ cdecl __stdio_common_vfprintf_p() ucrtbase.__stdio_common_vfprintf_p
@ cdecl __stdio_common_vfprintf_s() ucrtbase.__stdio_common_vfprintf_s
...
@ cdecl __stdio_common_vfwprintf_p() ucrtbase.__stdio_common_vfwprintf_p
@ cdecl __stdio_common_vfwprintf_s() ucrtbase.__stdio_common_vfwprintf_s
...
@ cdecl __stdio_common_vsprintf_p() ucrtbase.__stdio_common_vsprintf_p
...
@ cdecl _getws_s() ucrtbase._getws_s
...
@ cdecl _sopen_dispatch() ucrtbase._sopen_dispatch
...
@ cdecl _wsopen_dispatch() ucrtbase._wsopen_dispatch
...
@ cdecl clearerr_s() ucrtbase.clearerr_s

...
--*/
{
    ...
    _SEH2_TRY {
        ...
        Status = LdrpSearchResourceSection_U(AltResourceDllHandle,
											UIResourceIdPath,
											3,
											TRUE,
...
TryNextLangId:
        ...
        if ( ResourceEntry && !(ExactLangMatchOnly & 2)
		|| (ResourceEntry = ResourceDirectory) != 0 && ExactLangMatchOnly & 2 )
	    {
			*ResourceDirectoryOrData = ResourceEntry;

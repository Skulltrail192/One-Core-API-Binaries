...
@ stdcall IsWindowInDestroy(ptr)
@ stdcall IsWindowUnicode(ptr)
...
@ stdcall RegisterDeviceNotificationW(ptr ptr long)
...
@ stdcall ResolveDesktopForWOW(long) NtUserResolveDesktopForWOW

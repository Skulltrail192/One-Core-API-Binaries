...
@ stdcall SetThreadStackGuarantee(ptr) kernelfull.SetThreadStackGuarantee
...
;@ stdcall BaseProcessStartThunk(ptr ptr) BaseProcessStartTrunk ;kernelfull.BaseProcessStartThunk
...
@ stdcall GetStringScripts(long wstr long wstr long)
...
@ stdcall InitializeConditionVariable(ptr) ntdllbase.RtlInitializeConditionVariable
...
@ stdcall WakeAllConditionVariable(ptr) ntdllbase.RtlWakeAllConditionVariable
;@ stdcall WakeConditionVariable(ptr) ntdllbase.RtlWakeConditionVariable ;commented for now

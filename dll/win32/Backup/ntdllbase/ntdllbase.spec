...
@ fastcall -arch=i386 RtlUlonglongByteSwap(double)
...
@ stdcall LdrAlternateResourcesEnabled(ptr)
...
@ stdcall RtlFormatMessageEx(ptr long long long long ptr ptr long long) ntdll.RtlFormatMessageEx
...
@ stdcall RtlGetCurrentProcessorNumber() ntdll.NtGetCurrentProcessorNumber ; 5.2 SP1 and higher
...
#Longhorn pre-reset functions
@ stdcall RtlCloseDefinitionIdentityHandle(ptr long)
@ stdcall RtlGetDefinitionIdentityAttributeValue(ptr long long long)
@ stdcall RtlInitLUnicodeStringFromNullTerminatedString(str str)
...
@ stdcall RtlGetOSProductName(ptr long)

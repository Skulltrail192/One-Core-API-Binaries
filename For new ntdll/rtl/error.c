...
NTSTATUS NTAPI RtlMapSecurityErrorToNtStatus(ULONG SecurityError)
{
  NTSTATUS result; // eax@1

  result = SecurityError;
  switch ( SecurityError + 0x7FF6FD00 )
  {
    case 0u:
    ...
    case 0xAu:
      ...
      break;
    case 0xBu:
      result = STATUS_CANNOT_IMPERSONATE;
      break;
    case 0xCu:
    ...
    case 0xDu:
    case 0xEu:
      result = STATUS_NO_SUCH_LOGON_SESSION;
      break;
    case 0xFu:
    case 0x10u:
      ...
      break;
    case 0x11u:
      result = STATUS_NO_LOGON_SERVERS;
      break;
    case 5u:
    case 7u:
    case 0x16u:
      result = STATUS_NO_SUCH_PACKAGE;
      break;
    case 0x24u:
      result = STATUS_TIME_DIFFERENCE_AT_DC;
      break;
    default:
      return result;
  }

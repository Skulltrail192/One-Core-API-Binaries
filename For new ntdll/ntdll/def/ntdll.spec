...
@ stdcall -stub EtwpGetTraceBuffer(ptr ptr long long) #MISSING FUNCTION #ON TRACE.C FILE
@ stdcall -stub EtwpSetHWConfigFunction(long long) #MISSING FUNCTION #ON TRACE.C FILE
...
@ stdcall LdrFindResourceEx_U(long ptr ptr long ptr) ; 5.1 and higher #MISSING FUNCTION #ON RES.C FILE (apenas um stub ou oritundo de engenharia reversa e/ou WRK)
...
@ stdcall LdrSetDllManifestProber(ptr) #WINDOWS 2000 SOURCE #ON LDRAPI.C
...
@ stdcall PfxFindPrefix(ptr str)  #MISSING FUNCTION #ON PREFIX.C FILE
@ stdcall PfxInitialize(ptr)  #MISSING FUNCTION #ON PREFIX.C FILE
@ stdcall PfxInsertPrefix(ptr str ptr)  #MISSING FUNCTION #ON PREFIX.C FILE
@ stdcall PfxRemovePrefix(ptr ptr)  #MISSING FUNCTION #ON PREFIX.C FILE
...
@ stdcall RtlAddCompoundAce(ptr long long long ptr ptr) #Windows 2000 Source #ON ACL.C
...
@ stdcall RtlAddressInSectionTable(ptr ptr long) #Windows 2000 Source #ON IMAGE.C
...
@ stdcall RtlApplicationVerifierStop(long long long long long long long long long long) #MISSING FUNCTION #ON APPLICATION.C FILE
...
@ stdcall RtlCancelTimer(ptr ptr)  #MISSING FUNCTION #ON timerqueue.c FILE
...
@ stdcall RtlConvertUiListToApiList(ptr ptr long) #MISSING FUNCTION #ON UILIST.C FILE
...
@ stdcall RtlDebugPrintTimes() #Windows 2000 Source #ON THREAD.C
...
@ stdcall RtlEnableEarlyCriticalSectionEventCreation() #MISSING FUNCTION #ON CRITICAL.C FILE 
...
@ stdcall RtlFormatMessage(ptr long long long long ptr ptr long ptr) #Windows 2000 Source #ON MESSAGE.C
@ stdcall RtlFormatMessageEx(ptr long long long long ptr ptr long ptr long) #Windows 2000 Source #ON MESSAGE.C
...
@ stdcall RtlGetFrame()  #MISSING FUNCTION #ON FRAME.C FILE 
...
@ stdcall RtlGetUnloadEventTrace() #MISSING FUNCTION #ON TRACE.C FILE 
...
@ stdcall RtlInitializeAtomPackage(long) #Windows 2000 Source #ON ATOM.C
...
@ stdcall RtlInsertElementGenericTableFull(ptr ptr long ptr ptr long) #Uncommented
@ stdcall RtlInsertElementGenericTableFullAvl(ptr ptr long ptr ptr long) #Uncommented
...
@ stdcall RtlIsCriticalSectionLocked(ptr) #MISSING FUNCTION #ON CRITICAL.C FILE 
@ stdcall RtlIsCriticalSectionLockedByThread(ptr) #MISSING FUNCTION #ON UILIST.C FILE (apenas um stub ou oritundo de engenharia reversa e/ou WRK)
...
@ stdcall RtlLogStackBackTrace() #Windows 2000 Source #ON STKTRACE.C
@ stdcall RtlLookupAtomInAtomTable(ptr wstr ptr)
@ stdcall RtlLookupElementGenericTable(ptr ptr)
@ stdcall RtlLookupElementGenericTableAvl(ptr ptr)
@ stdcall RtlLookupElementGenericTableFull(ptr ptr ptr long) #Uncommented
@ stdcall RtlLookupElementGenericTableFullAvl(ptr ptr ptr long) #Uncommented
...
@ stdcall RtlMultipleAllocateHeap(ptr long long long ptr) #Uncommented #Unimplemented
@ stdcall RtlMultipleFreeHeap(ptr long long ptr) #Uncommented #Unimplemented
...
@ stdcall RtlQueueApcWow64Thread(ptr ptr ptr ptr ptr) #MISSING FUNCTION #ON THREAD.C FILE 
...
@ stdcall RtlSetUnicodeCallouts(long) # -  #MISSING FUNCTION #ON UNICODE.C FILE
...
@ stdcall RtlTraceDatabaseCreate(long long long long long)
...
@ stdcall RtlUnhandledExceptionFilter2(ptr long)  #MISSING FUNCTION #ON EXCEPTION.C FILE
...
@ stdcall ZwAddDriverEntry(ptr long) NtAddDriverEntry
...
@ stdcall ZwApphelpCacheControl(long ptr) NtApphelpCacheControl
...
@ stdcall ZwDeleteDriverEntry(long) NtDeleteDriverEntry
...
@ stdcall ZwEnumerateDriverEntries(ptr ptr) NtEnumerateDriverEntries
...
@ stdcall ZwLoadKeyEx(ptr ptr long ptr) NtLoadKeyEx
...
@ stdcall ZwModifyDriverEntry(ptr) NtModifyDriverEntry
...
@ stdcall ZwQueryDriverEntryOrder(ptr ptr) NtQueryDriverEntryOrder
...
@ stdcall ZwQueryOpenSubKeysEx(ptr long ptr ptr) NtQueryOpenSubKeysEx
...
@ stdcall ZwSetDriverEntryOrder(ptr ptr) NtSetDriverEntryOrder
...
@ stdcall ZwUnloadKey2(ptr long) NtUnloadKey2
...
@ stdcall ZwWaitForMultipleObjects32(long ptr long long ptr) NtWaitForMultipleObjects32
...
@ cdecl _wcstoui64(wstr wstr long) #MISSING FUNCTION
@ cdecl _wcsupr(wstr)
@ cdecl _wtoi(wstr)
@ cdecl _wtoi64(wstr)
@ cdecl _wtol(wstr)
...
##Legenda:
# -  #MISSING FUNCTION #ON UILIST.C FILE (apenas um stub ou oritundo de engenharia reversa e/ou WRK)
# -  #Windows 2000 Source #ON MESSAGE.C(Código oriundo diretamente do Windows 2000)
# -  #Uncommented(Já existente e descomentado para ser exportado)
# -  #Unimplemented(Já é sabido que não está implementado)
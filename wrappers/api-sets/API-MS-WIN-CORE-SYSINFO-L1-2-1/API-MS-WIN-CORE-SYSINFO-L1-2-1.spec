@ stdcall DnsHostnameToComputerNameExW(wstr wstr ptr) kernel32.DnsHostnameToComputerNameExW
...
@ stdcall InstallELAMCertificateInfo(ptr) kernel32.InstallELAMCertificateInfo
@ stdcall SetComputerNameEx2W(long long wstr) kernel32.SetComputerNameEx2W

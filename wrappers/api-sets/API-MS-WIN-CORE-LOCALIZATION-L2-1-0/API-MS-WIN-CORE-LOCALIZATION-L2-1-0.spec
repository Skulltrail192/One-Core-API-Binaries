...
@ stdcall GetCurrencyFormatEx(wstr long wstr ptr wstr long) kernelbase.GetCurrencyFormatEx
@ stdcall GetCurrencyFormatW(long long str ptr str long) kernelbase.GetCurrencyFormatW

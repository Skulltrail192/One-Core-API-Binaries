...
@ stdcall EnumResourceNamesExA(ptr str ptr long long long) kernelbase.EnumResourceNamesExA
@ stdcall EnumResourceNamesExW(ptr wstr ptr long long long) kernelbase.EnumResourceNamesExW
@ stdcall EnumResourceTypesExA(ptr ptr long long long) kernelbase.EnumResourceTypesExA
@ stdcall EnumResourceTypesExW(ptr ptr long long long) kernelbase.EnumResourceTypesExW

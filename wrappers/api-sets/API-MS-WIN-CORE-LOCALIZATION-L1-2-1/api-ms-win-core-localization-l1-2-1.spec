...
@ stdcall GetUILanguageInfo(long wstr wstr ptr ptr) kernelbase.GetUILanguageInfo
...
@ stdcall SetProcessPreferredUILanguages(long wstr ptr) kernelbase.SetProcessPreferredUILanguages

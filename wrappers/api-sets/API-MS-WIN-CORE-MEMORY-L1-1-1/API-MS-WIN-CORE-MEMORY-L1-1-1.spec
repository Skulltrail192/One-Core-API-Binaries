@ stub CreateFileMappingFromApp ;(ptr ptr long int64 wstr) kernelbase.CreateFileMappingFromApp
...
@ stub MapViewOfFileFromApp  ;(ptr long int64 long) kernelbase.MapViewOfFileFromApp
@ stdcall OpenFileMappingW(long long wstr) kernelbase.OpenFileMappingW
@ stub PrefetchVirtualMemory ;(ptr long ptr long) kernelbase.PrefetchVirtualMemory
...
@ stub UnmapViewOfFileEx ;(ptr long) kernelbase.UnmapViewOfFileEx

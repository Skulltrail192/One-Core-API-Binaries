...
@ stdcall CoCancelCall(long long) olebase.CoCancelCall
...
@ stdcall CoDisableCallCancellation(ptr) olebase.CoDisableCallCancellation
@ stub CoDisconnectContext
@ stdcall CoDisconnectObject(ptr long) olebase.CoDisconnectObject
@ stdcall CoEnableCallCancellation(ptr) olebase.CoEnableCallCancellation
...
@ stub CoGetApartmentType ;(ptr ptr) olebase.CoGetApartmentType
@ stdcall CoGetCallContext(ptr ptr) olebase.CoGetCallContext
@ stdcall CoGetCallerTID(ptr) olebase.CoGetCallerTID
@ stdcall CoGetCancelObject(long long ptr) olebase.CoGetCancelObject
...
@ stdcall CoGetStdMarshalEx(ptr long ptr) olebase.CoGetStdMarshalEx
...
@ stdcall CoQueryAuthenticationServices(ptr ptr) olebase.CoQueryAuthenticationServices

...
@ cdecl _atoi64_l(str long) ucrtbase._atoi64_l
@ cdecl _atoi_l(str ptr) ucrtbase._atoi_l
@ cdecl _atol_l(str long) ucrtbase._atol_l
@ cdecl _atoldbl(ptr str) ucrtbase._atoldbl
@ cdecl _atoldbl_l(ptr str long) ucrtbase._atoldbl_l
...
@ cdecl _strtoimax_l(str str long long) ucrtbase._strtoimax_l
@ cdecl _strtol_l(str ptr long ptr) ucrtbase._strtol_l
@ cdecl _strtold_l(str str long) ucrtbase._strtold_l
...
@ cdecl _strtoumax_l(str str long long) ucrtbase._strtoumax_l
...
@ cdecl _wcstoimax_l(wstr wstr long long) ucrtbase._wcstoimax_l
@ cdecl _wcstol_l(wstr ptr long ptr) ucrtbase._wcstol_l
@ cdecl _wcstold_l(wstr wstr long) ucrtbase._wcstold_l
...
@ cdecl _wcstoull_l(wstr wstr long long) ucrtbase._wcstoull_l
@ cdecl _wcstoumax_l(wstr wstr long long) ucrtbase._wcstoumax_l
...
@ cdecl c16rtomb(str str ptr) ucrtbase.c16rtomb
@ cdecl c32rtomb(str str ptr) ucrtbase.c32rtomb
@ cdecl mbrtoc16(str str long ptr) ucrtbase.mbrtoc16
@ cdecl mbrtoc32(str str long ptr) ucrtbase.mbrtoc32
...
@ cdecl strtoimax(str str long) ucrtbase.strtoimax
@ cdecl strtol(str ptr long) ucrtbase.strtol
@ cdecl strtold(str str) ucrtbase.strtold
...
@ cdecl strtoumax(str str long) ucrtbase.strtoumax
@ cdecl wcrtomb(ptr long ptr) ucrtbase.wcrtomb
@ cdecl wcrtomb_s(ptr str wstr ptr) ucrtbase.wcrtomb_s
...
@ cdecl wcstoimax(wstr wstr long) ucrtbase.wcstoimax
@ cdecl wcstol(wstr ptr long) ucrtbase.wcstol
@ cdecl wcstold(wstr wstr) ucrtbase.wcstold
...
@ cdecl wcstoull(wstr wstr long) ucrtbase.wcstoull
@ cdecl wcstoumax(wstr wstr long) ucrtbase.wcstoumax

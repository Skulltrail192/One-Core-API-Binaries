...
@ stdcall GetWindowDisplayAffinity(ptr ptr) user32.GetWindowDisplayAffinity
...
@ stdcall LogicalToPhysicalPoint(ptr ptr) user32.LogicalToPhysicalPoint
...
@ stdcall SetWindowDisplayAffinity(ptr long) user32.SetWindowDisplayAffinity

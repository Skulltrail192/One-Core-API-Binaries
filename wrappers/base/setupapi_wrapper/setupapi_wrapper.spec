...
@ stdcall CMP_GetBlockedDriverInfo(str long long long)
@ stdcall CMP_GetServerSideDeviceInstallFlags(ptr)
...
@ stdcall CM_Add_Range(long long long long)
...
@ stdcall CM_Create_Range_List(long long)
...
@ stdcall CM_Delete_Range(long long long long)
@ stdcall CM_Detect_Resource_Conflict(ptr long ptr long ptr long)
@ stdcall CM_Detect_Resource_Conflict_Ex(ptr long ptr long ptr long ptr)
...
@ stdcall CM_Find_Range(ptr long long long long ptr long)
...
@ stdcall CM_Invert_Range_List(ptr ptr long long)
...
@ stdcall CM_Query_Resource_Conflict_List(ptr ptr long ptr long long ptr)
...
@ stdcall CM_Test_Range_Available(long long ptr long)
...
@ stdcall ExtensionPropSheetPageProc(long ptr long)
...
@ stdcall SetupAdjustDiskSpaceListA(ptr str long long ptr long)
@ stdcall SetupAdjustDiskSpaceListW(ptr wstr long long ptr long)
@ stdcall SetupBackupErrorA(ptr str str str long long)
@ stdcall SetupBackupErrorW(ptr wstr wstr wstr long long)
...
@ stdcall SetupDiAskForOEMDisk(ptr ptr)
...
@ stdcall SetupDiCancelDriverInfoSearch(ptr)
...
@ stdcall SetupDiDrawMiniIcon(ptr ptr long long)
...
@ stdcall SetupDiGetHwProfileFriendlyNameA(long str long ptr)
@ stdcall SetupDiGetHwProfileFriendlyNameExA(long str long ptr str ptr)
@ stdcall SetupDiGetHwProfileFriendlyNameExW(long wstr long ptr wstr ptr)
@ stdcall SetupDiGetHwProfileFriendlyNameW(long wstr long ptr)
@ stdcall SetupDiGetHwProfileList(ptr long ptr ptr)
@ stdcall SetupDiGetHwProfileListExA(ptr long ptr ptr str ptr)
@ stdcall SetupDiGetHwProfileListExW(ptr long ptr ptr wstr ptr)
...
@ stdcall SetupDiGetWizardPage(ptr ptr ptr long long)
...
@ stdcall SetupDiMoveDuplicateDevice(ptr ptr)
...
@ stdcall SetupDiSetDeviceInterfaceDefault(ptr ptr long ptr)
...
@ stdcall SetupFreeSourceListA(str long)
@ stdcall SetupFreeSourceListW(wstr long)
@ stdcall SetupGetBackupInformationA(ptr ptr)
@ stdcall SetupGetBackupInformationW(ptr ptr)
...
@ stdcall SetupGetInfSections(ptr ptr ptr ptr)
...
@ stdcall SetupPrepareQueueForRestoreA(ptr str long)
@ stdcall SetupPrepareQueueForRestoreW(ptr wstr long)
...
@ stdcall SetupQueryDrivesInDiskSpaceListA(ptr str long ptr)
@ stdcall SetupQueryDrivesInDiskSpaceListW(ptr wstr long ptr)
@ stdcall SetupQueryFileLogA(ptr str str ptr str long ptr)
@ stdcall SetupQueryFileLogW(ptr wstr wstr ptr wstr long ptr)
...
@ stdcall SetupQueryInfVersionInformationA(ptr long str str long ptr)
@ stdcall SetupQueryInfVersionInformationW(ptr long wstr wstr long ptr)
@ stdcall SetupQuerySourceListA(long str ptr)
@ stdcall SetupQuerySourceListW(long wstr ptr)
...
@ stdcall SetupRemoveFileLogEntryA(ptr str str)
@ stdcall SetupRemoveFileLogEntryW(ptr wstr wstr)
@ stdcall SetupRemoveFromDiskSpaceListA(ptr str long ptr long)
...
@ stdcall SetupRemoveInstallSectionFromDiskSpaceListA(ptr ptr ptr str ptr long)
@ stdcall SetupRemoveInstallSectionFromDiskSpaceListW(ptr ptr ptr wstr ptr long)
@ stdcall SetupRemoveSectionFromDiskSpaceListA(ptr ptr ptr str long ptr long)
@ stdcall SetupRemoveSectionFromDiskSpaceListW(ptr ptr ptr wstr long ptr long)
...
@ stdcall SetupSetDirectoryIdExA(ptr long str long long ptr)
@ stdcall SetupSetDirectoryIdExW(ptr long wstr long long ptr)
...
@ stdcall SetupSetPlatformPathOverrideA(str)
@ stdcall SetupSetPlatformPathOverrideW(wstr)
...
@ stdcall SetupUninstallNewlyCopiedInfs(ptr long ptr)
...
@ stdcall VerifyCatalogFile(long wstr long long long long)
@ stdcall pSetupAccessRunOnceNodeList()
@ stdcall pSetupAcquireSCMLock(ptr ptr)
@ stdcall pSetupAddMiniIconToList(ptr ptr)
@ stdcall pSetupAddTagToGroupOrderListEntry(wstr ptr ptr)
@ stdcall pSetupAppendStringToMultiSz(ptr wstr long wstr wstr long)
...
@ stdcall pSetupDestroyRunOnceNodeList()
@ stdcall pSetupDiGetDeviceInfoContext(ptr ptr ptr)
@ stdcall pSetupDiSetDeviceInfoContext(ptr ptr ptr)
@ stdcall pSetupDoesUserHavePrivilege(wstr)
@ stdcall pSetupDuplicateString(wstr)
@ stdcall pSetupEnablePrivilege(wstr long)
@ stdcall pSetupFree(ptr)
@ stdcall pSetupFreeStringArray(ptr ptr)
@ stdcall pSetupGetCurrentDriverSigningPolicy(ptr)
@ stdcall pSetupGetField(ptr long)
@ stdcall pSetupGetFileTitle(wstr)
@ stdcall pSetupGetGlobalFlags()
@ stdcall pSetupGetInfSections(ptr ptr ptr ptr)
...
@ stdcall pSetupHandleFailedVerification(ptr ptr wstr long long long long long long long)
...
@ stdcall pSetupModifyGlobalFlags(ptr ptr)
@ stdcall pSetupMultiByteToUnicode(str long)
@ stdcall pSetupOpenAndMapFileForRead(wstr ptr ptr ptr ptr)
@ stdcall pSetupOutOfMemory(ptr)
@ stdcall pSetupQueryMultiSzValueToArray(ptr wstr wstr ptr ptr ptr)
@ stdcall pSetupRealloc(ptr long)
@ stdcall pSetupRegistryDelnode(long long)
@ stdcall pSetupRetrieveServiceConfig(ptr long)
@ stdcall pSetupSetArrayToMultiSzValue(ptr wstr wstr ptr ptr)
@ stdcall pSetupSetGlobalFlags(long)
@ stdcall pSetupSetNoDriverPrompts(long)
@ stdcall pSetupSetQueueFlags(ptr long)
@ stdcall pSetupSetSystemSourcePath(wstr ptr)
@ stdcall pSetupShouldDeviceBeExcluded(wstr ptr ptr)
...
@ stdcall pSetupStringTableEnum(ptr ptr ptr ptr ptr)
...
@ stdcall pSetupVerifyCatalogFile(wstr)
@ stdcall pSetupVerifyFile(ptr ptr ptr ptr ptr ptr ptr ptr ptr ptr ptr ptr)
@ stdcall pSetupVerifyQueuedCatalogs(ptr)
@ stdcall pSetupWriteLogEntry(ptr ptr long ptr str)

...
@ stdcall NtAlpcAcceptConnectPort(ptr ptr long ptr ptr ptr ptr ptr long) ntdllnew.NtAlpcAcceptConnectPort 
@ stdcall NtAlpcCancelMessage(ptr long ptr)	
@ stdcall NtAlpcConnectPort(ptr ptr ptr ptr long ptr ptr ptr ptr ptr ptr) ntdllnew.NtAlpcConnectPort ;Error, Services not starts
@ stdcall NtAlpcCreatePort(ptr ptr ptr) ntdllnew.NtAlpcCreatePort
...
@ stdcall NtAlpcImpersonateClientOfPort(ptr ptr ptr) ntdllnew.NtAlpcImpersonateClientOfPort
@ stdcall NtAlpcQueryInformation(ptr ptr ptr long ptr) ntdllnew.NtAlpcQueryInformation 
@ stdcall NtAlpcSendWaitReceivePort(ptr long ptr ptr ptr ptr ptr ptr) ntdll.NtAlpcSendWaitReceivePort ;Black Screen
@ stdcall NtAlpcSetInformation(ptr ptr ptr long) ;ntdll.NtAlpcSetInformation

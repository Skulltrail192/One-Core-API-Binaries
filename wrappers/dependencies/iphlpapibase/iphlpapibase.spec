...
@ stdcall CancelSecurityHealthChangeNotify(ptr)
...
@ stdcall NotifySecurityHealthChange(ptr ptr ptr) ;Server 2003 (2k3)
...
@ stdcall _PfAddFiltersToInterface@24(ptr long ptr long ptr ptr) _PfAddFiltersToInterface
@ stdcall _PfAddGlobalFilterToInterface@8(ptr long) _PfAddGlobalFilterToInterface
@ stdcall _PfBindInterfaceToIPAddress@12(ptr ptr ptr) _PfBindInterfaceToIPAddress
@ stdcall _PfBindInterfaceToIndex@16(ptr long ptr ptr) _PfBindInterfaceToIndex
@ stdcall _PfCreateInterface@24(long long long long long ptr) _PfCreateInterface
@ stdcall _PfDeleteInterface@4(ptr) _PfDeleteInterface
@ stdcall _PfDeleteLog@0() _PfDeleteLog
@ stdcall _PfGetInterfaceStatistics@16(ptr ptr ptr long) _PfGetInterfaceStatistics
@ stdcall _PfMakeLog@4(ptr) _PfMakeLog
@ stdcall _PfRebindFilters@8(ptr ptr) _PfRebindFilters
@ stdcall _PfRemoveFilterHandles@12(ptr long ptr) _PfRemoveFilterHandles
@ stdcall _PfRemoveFiltersFromInterface@20(ptr long ptr long ptr) _PfRemoveFiltersFromInterface
@ stdcall _PfRemoveGlobalFilterFromInterface@8(ptr long) _PfRemoveGlobalFilterFromInterface
@ stdcall _PfSetLogBuffer@28(ptr long long long ptr ptr ptr) _PfSetLogBuffer
@ stdcall _PfTestPacket@20(ptr ptr long ptr ptr) _PfTestPacket
@ stdcall _PfUnBindInterface@4(ptr) _PfUnBindInterface
